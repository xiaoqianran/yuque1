...
**当前发布**：**[v0.6.0](https://github.com/xiaoqianran/yuque1/releases/tag/v0.6.0)**（OpenAPI **0.1.9**）
...
| 知识库 | 创建/列表/改名/简介/软删 |
| 文档树 | folder/doc、搜索、重命名、移动、同级上移/下移、删除 |
| 正文 | 乐观锁保存 / 冲突覆盖 / 另存 / **防抖自动保存** / **MD 预览** / 覆盖快照 |
